...
export class MarketplaceCheckoutComponent implements OnInit{
  ...
  readonly form=this.fb.group({customerFullName:['',Validators.required],customerEmail:['',[Validators.required,Validators.email]],customerPhone:['',Validators.required],customerIdentityNumber:['',Validators.required],insurancePackageId:[null as number|null],terms:[false,Validators.requiredTrue]});
